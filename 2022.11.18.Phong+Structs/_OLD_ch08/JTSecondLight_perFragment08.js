...
/*		-- For Lamp0 (our 1st light source) **NOW HELD IN lightsT object 'lamp0'***
...
/*	// OBSOLETE -- Now held in LightsT lamp0 object.
...
/* OBSOLETE-- replaced by lamp0 object
...
/* OBSOLETE -- held in LightsT lamp0 object:
// Init World-coord. position & colors of first light source in global vars;
...
//	console.log('lamp0.I_ambi.elements', lamp0.I_ambi.elements, '\n');
//  gl.uniform3fv(lamp0.u_pos,  lamp0Pos);
//		 ('slice(0,3) member func returns elements 0,1,2 (x,y,z) ) 
//  gl.uniform3fv(lamp0.u_ambi, lamp0Ambi);		// ambient
//  gl.uniform3fv(lamp0.u_diff, lamp0Diff);		// diffuse
//  gl.uniform3fv(lamp0.u_spec, lamp0Spec);		// Specular
