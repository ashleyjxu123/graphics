...
//Mouse-Drag Moves Lamp0 ========================================================
	...
	//  use the same method to change the x,y coords of lamp0Pos)
	lamp0Pos.set([lamp0Pos[0] + 3.0*(x - xMclik),		// scale up by 3...
						    lamp0Pos[1] + 3.0*(y - yMclik),
						    lamp0Pos[2]]);				// don't change z component).
	// VERY IMPORTANT!
