...
var g_frogAngle1 = 0.0;
var g_frogAngle2 = 0.0;
var g_frogAngle3 = 0.0;
...
var matlSel0 = MATL_CHROME;
var matlSel1 = MATL_BRONZE_SHINY;
var matlSel2 = MATL_EMERALD;
var matlSel3 = MATL_TURQUOISE;
var g_matl0 = new Material(matlSel0);
var g_matl1 = new Material(matlSel1);
var g_matl2 = new Material(matlSel2);
var g_matl3 = new Material(matlSel3);
...
function animate() {
  ...
  g_frogAngle1 += (ANGLE_STEP * elapsed) / 1000.0;
  g_frogAngle1 = g_frogAngle1 % 360;

  g_frogAngle2 += (ANGLE_STEP * elapsed) / 1000.0;
  g_frogAngle2 = g_frogAngle2 % 360;

  g_frogAngle3 += (ANGLE_STEP * elapsed) / 1000.0;
  g_frogAngle3 = g_frogAngle3 % 360;
  /*
   * Lamp Updates
   */
  //console.log( g_lamp0.I_pos[0]);
