...
var g_angleRate = 45.0;  // angleRotation angle rate (degrees/second)
...
*/
  ...
  g_nVerts = 48;	// 12 tetrahedron vertices; 36 cube verts (6 per side*6 sides)
...
/*      //  limit the angle to move smoothly between +20 and -85 degrees:
  if(angle >  120.0 && g_angleRate > 0) g_angleRate = -g_angleRate;
  if(angle < -120.0 && g_angleRate < 0) g_angleRate = -g_angleRate;
*/
  return newAngle %= 360;	
}
